...
const Home = ({ dishes, banner, gallery, service, testimonials, categories }) => {
    const dispatch = useDispatch();
    const { bannerHeader, bannerDesc, aboutHeader, aboutDesc } = useSelector((store) => store.content);
    ...
    return (
        <div className='home-container'>
            <div className="modals">
                {orderModal && <div className="order-modal">
                    <OrderModal />
                </div>}
                {reserveModal && <div className='order-modal'>
                    <ReserveModal />
                </div>}
            </div>
            <div className="widgets">
                <button className=' btn-primary' onClick={handleReserve}>Reserve Now</button>
            ...
            <section className="dishes">
                    ...
                    {filteredDishes?.length ? filteredDishes?.map((dish, index) => (
                        <li key={dish.id}>
                            ...
                            <div className="dish-footer">
                                ...
                                <button className='' onClick={() => handleDishDisplay(index)}>See details</button>
                            </div>
                        </li>
                    )) : <li>No images to display</li>}
                </ul>
                <div className={meal ? 'dish-display' : 'no-display'}>
                    ...
                    <div className="dish-details">
                        ...
                        <span className='p-text'>${meal?.price}</span>
